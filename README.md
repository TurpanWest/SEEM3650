# SEEM3650 Group Project
  ...
  The analysis_code.ipynb is the data analysis code.<br />The solution_code.ipynb is the data processing and machine learning code.<br />Data.csv is the data needed.
